...
export const sidebarConfig = sidebar({
  ...
  "/front-end-basics/css/": [
        ...
        { text: '第1节 CSS简介', link: '/front-end-basics/css/第1节CSS简介.md'},
        { text: '第2节 CSS选择器', link: '/front-end-basics/css/第2节CSS选择器.md'},
        { text: '第3节 CSS盒子模型', link: '/front-end-basics/css/第3节CSS盒子模型.md'},
        { text: '第4节 CSS浮动与清除', link: '/front-end-basics/css/第4节CSS浮动与清除.md'},
        { text: '第5节 CSS定位', link: '/front-end-basics/css/第5节CSS定位.md'},
        { text: '第6节 CSS背景', link: '/front-end-basics/css/第6节CSS背景.md'},
        { text: '第7节 CSS字体和文本', link: '/front-end-basics/css/第7节CSS字体和文本.md'},
        { text: '第8节 CSS布局', link: '/front-end-basics/css/第8节CSS布局.md'},
        { text: '第9节 水平垂直居中', link: '/front-end-basics/css/第9节水平垂直居中.md'},
        { text: '第10节 CSS3', link: '/front-end-basics/css/第10节CSS3.md'},
        { text: 'CSS工具', link: '/front-end-basics/css/CSS工具.md'}
  ],
  "/zhishixingqiu/": [
    "readme.md",
    "map",
